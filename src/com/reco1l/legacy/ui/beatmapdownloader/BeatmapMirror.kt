...
enum class SortOption(val apiValue: String, val displayName: String) {
    ...
    DIFFICULTY_ASC("difficulty:asc", "Difficulty (Low)"),
    DIFFICULTY_DESC("difficulty:desc", "Difficulty (High)"),
    RATING_ASC("rating:asc", "Rating (Low)"),
    RATING_DESC("rating:desc", "Rating (High)"),
